      ...
      <div class="modal-footer">
       ...
       <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit"  onClick={this.firstclickshow.bind(this)}  class="btn btn-primary">Sign Up</button>
              ...
              <div class="col-md-6">
              <br/>
              <h1 style={{color:"#EEECEC", fontFamily:"bold" ,textShadow:" -1px 0 black, 0 5px black, 1px 0 black, 0 -1px black"}}>Log in first to get the <br/><br/> experience of Food Hub</h1>
           </div>
